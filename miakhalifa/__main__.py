...
SOURCE_STRING = """
⚡I'm built in python3, using the python-telegram-bot library, and am fully opensource - you can find what makes me tick [here](https://github.com/wafikhsalman/Mia-Khalifa-Bot)
⚡You Can Clone Me [Here](https://heroku.com/deploy?template=https://github.com/wafikhsalman/Mia-Khalifa-Bot)
"""
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="🤝Help",callback_data="help_back"),InlineKeyboardButton(text="🛡Creator🛡",url="https://t.me/Wafikh")]]
    keyboard += [[InlineKeyboardButton(text="🛡️GROUP🛡️", url="https://t.me/NN_NAZRIYANAZEEMBETA"),InlineKeyboardButton(text="🛡️Channel🛡️",url="https://t.me/NN_NAZRIYANAZEEM_BETA")]] 
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="⚜️Help",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="🛡Updates",url="https://t.me/NN_NAZRIYANAZEEM_BETA")]]))
        return
